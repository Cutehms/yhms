...
🖇┇أو أرسال لي بحث + أسم الأغنية للبحث عنها في اليوتيوب.
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉",
      reply_markup=InlineKeyboardMarkup(
         [
            [
               InlineKeyboardButton("◜ 𝙼𝙰𝚈 𝙱𝙾𝚃𝚂 𓃠◞ ⁞", url=f"https://t.me/botatiiii/1443"),
...
async def search(client, message):
    try:
        ...
        while i < 5:
            ...
            i += 1
        await m.edit(text, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("◜ 𝙼𝙰𝚈 𝙱𝙾𝚃𝚂 𓃠◞ ⁞ Bots Service", url="https://t.me/botatiiii")]]), disable_web_page_preview=True)
    except Exception as e:
        await m.edit(str(e))
